...
public class Rasterizer {
    private static readonly TileType Space = new(0x00fe, "Space");
    ...
    public void Rasterize(RasterizationStep? targetStep = null) {
        while (Step != targetStep && Step != RasterizationStep.Finish) RunStep();
    }
    ...
    private void RasterizeCorridor(MapCorridor corridor, Edge edge) {
        CreateCorridor(edge.RoomA, edge.RoomB, out var srcPos, out var dstPos);
