...
internal class NormalRoom : FixedRoom {
    ...
    private static readonly DungeonObject destWall = new() {
    ...
    private struct RoomTemplate {
        ...
        public RoomTemplate(Rect bounds, Range numBranches, RoomFlags flags,
            params Tuple<Direction, int>[] connections) {
            Bounds = bounds;
            Flags = flags;
